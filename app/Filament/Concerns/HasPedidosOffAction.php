...
trait HasPedidosOffAction
{
    protected function makePedidosOffAction(): Action
    {
        return Action::make('OFF')
            ...
            ->modalDescription('Ningún producto aparecerá en la tabla Pedidos de los clientes hasta que actives productos individualmente desde Programas o Cards (30 minutos).')
