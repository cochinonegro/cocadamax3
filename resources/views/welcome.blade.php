...
<body class="min-h-screen bg-zinc-950 text-zinc-100 antialiased">
    <div class="mx-auto flex min-h-screen max-w-5xl flex-col justify-center px-4 py-10 sm:px-6">
        <header class="mb-10 text-center">
            ...
            <p class="mx-auto mt-3 max-w-xl text-sm text-zinc-400">
                Crea tu acceso de invitado o inicia sesión para ver y descargar programas.
            </p>
        </header>
        ...
        <div class="grid gap-6 lg:grid-cols-2">
            {{-- Crear usuario --}}
            <section class="rounded-2xl border border-zinc-800 bg-zinc-900/70 p-6 shadow-xl">
                <h2 class="mb-1 text-lg font-semibold text-white">Crear usuario</h2>
                ...
                <form action="{{ route('welcome.register') }}" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            value="{{ old('name') }}"
                            required
                            class="w-full rounded-lg border border-zinc-700 bg-zinc-950 px-3 py-2 text-sm text-white outline-none ring-amber-500/0 transition focus:border-amber-500 focus:ring-2 focus:ring-amber-500/30"
