                ...
                @forelse ($this->programas as $programa)
                    ...
                    >
                        <a
                            ...
                            class="tienda-producto-card__link"
                        >
                        ...
                        <div class="tienda-producto-card__actions">
                            @livewire('solicitar-programa-button', ['programaId' => $programa->id, 'variant' => 'card'], key('solicitar-tienda-'.$programa->id))
                        </div>
                    </article>
                @empty
